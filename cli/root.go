...
type App struct {
	client   *wolframfns.Client
	cfg      wolframfns.Config
	output   string
	fields   []string
	noHeader bool
	template string
...
func Root() *cobra.Command {
	app := &App{cfg: wolframfns.DefaultConfig()}

	root := &cobra.Command{
		Use:           "wolframfns",
		Short:         "Browse mathematical functions from functions.wolfram.com",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = wolframfns.NewClient(a.cfg)
	return nil
}
