...
Most of these come down to network reality or how wolframfns serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

wolframfns rate-limits like any public site. wolframfns already paces
...
Where a surface is gated, wolframfns reads a cookie or token you supply
...
`wolframfns`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what wolframfns actually did
